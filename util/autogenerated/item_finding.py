...
Auto-generated from the WalkScape tools API loot_tables.
...
class ItemFindingCategory:
    ...
    BIRD_NEST = CategoryInstance(
        name='Bird Nest',
        drops=[
            DropEntry(item_name='Bird nest', item_ref='Container.BIRD_NEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=100.0),
        ]
    )
    ...
    CRUSTACEAN = CategoryInstance(
        name='Crustacean',
        drops=[
            DropEntry(item_name='Raw crab', item_ref='Material.RAW_CRAB', quantity=Quantity(min_qty=1, max_qty=2), chance_percent=54.545),
            DropEntry(item_name='Raw lobster', item_ref='Material.RAW_LOBSTER', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=36.364),
            DropEntry(item_name='Raw shrimp', item_ref='Material.RAW_SHRIMP', quantity=Quantity(min_qty=3, max_qty=6), chance_percent=9.091),
        ]
    )
    ...
    FIBROUS_PLANT = CategoryInstance(
        name='Fibrous Plant',
        drops=[
            DropEntry(item_name='Hemp', item_ref='Material.HEMP', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=70.0),
            DropEntry(item_name='Flax', item_ref='Material.FLAX', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=30.0),
        ]
    )
    ...
    RANDOM_PIECE_OF_JUNK = CategoryInstance(
        ...
        drops=[
            DropEntry(item_name='Trash', item_ref='Material.TRASH', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=48.454),
            DropEntry(item_name='Fishbone', item_ref='Material.FISHBONE', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.247),
            ...
            DropEntry(item_name='Copper arrows', item_ref='Material.COPPER_ARROWS', quantity=Quantity(min_qty=1, max_qty=3), chance_percent=5.155),
    ...
    SKILL_CHEST = CategoryInstance(
        name='Skill Chest',
        drops=[
            DropEntry(item_name='Agility chest', item_ref='Container.AGILITY_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Carpentry chest', item_ref='Container.CARPENTRY_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Cooking chest', item_ref='Container.COOKING_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Crafting chest', item_ref='Container.CRAFTING_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Fishing chest', item_ref='Container.FISHING_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Foraging chest', item_ref='Container.FORAGING_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Hunting chest', item_ref='Container.HUNTING_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Mining chest', item_ref='Container.MINING_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Smithing chest', item_ref='Container.SMITHING_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Tailoring chest', item_ref='Container.TAILORING_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Trinketry chest', item_ref='Container.TRINKETRY_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
            DropEntry(item_name='Woodcutting chest', item_ref='Container.WOODCUTTING_CHEST', quantity=Quantity(min_qty=1, max_qty=1), chance_percent=8.333),
        ]
    )
